                        ...
                        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                            <div class="bg-white rounded my-1">
                                ...
                                <div v-if="$page.props.matriculas.data.length === 0" class="w-full px-4 py-2 flex items-center justify-center">
                                    <h2>O aluno não possui matriculas</h2>
                                </div>
...
export default {
    ...
    methods: {
        async onDelete(data) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    let uri = this.route('admin.deletar.matricula');
                    await this.deletarMatricula(data, uri, this.$page.props.aluno.id)
                }
            })
        },
        ...
        openModalCadastrarMatricula() {
            let aluno = this.$page.props.aluno
